...
function AirPodsMacInfo() {
  ...
  return (
    <>
      <div className="mb-[1vh] flex h-[5.5vh] w-[17vh] flex-col items-center justify-center rounded-2xl bg-gray-200 text-sm transition duration-300 dark:bg-gray-800 dark:text-white">
...
function AppInfo() {
  ...
  return (
    <div className="flex h-[12vh] w-[17vh] flex-col items-center justify-center rounded-2xl bg-gray-200 text-sm transition duration-300 dark:bg-gray-800 dark:text-white">
