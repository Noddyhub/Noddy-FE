  ...
  return (
    <div className="mb-2 flex w-[45vh] flex-row items-center justify-between rounded-2xl px-2">
      ...
      <div className="flex flex-row">
        <input
          type="range"
          className="h-2 w-[12.5vh] cursor-pointer appearance-none rounded-lg bg-gray-200 accent-blue-500 shadow transition duration-300 hover:shadow-md dark:bg-gray-800 dark:accent-blue-200"
          min={min}
          max={max}
          step={step}
          value={value}
